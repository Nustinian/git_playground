...
button1 = Button(window, text = "View All", command = lambda: bb.view_all())
button2 = Button(window, text = "Search Entry", command = lambda: bb.search_entry(entry1_value.get(), entry2_value.get(), entry3_value.get(), entry4_value.get()))
...
button5 = Button(window, text = "Delete Selected", command = lambda: bb.delete_selected(listbox.curselection()))
